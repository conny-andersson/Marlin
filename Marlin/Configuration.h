...
#define CUSTOM_MACHINE_NAME "C3DP-E5"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
//#define MACHINE_UUID "f0902eaf-07e1-4fd3-bb29-90e0dad76d98"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 112.03
  #define DEFAULT_BED_KI  21.88
  #define DEFAULT_BED_KD 382.41
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -6, -2 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
